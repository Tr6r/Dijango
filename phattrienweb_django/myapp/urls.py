...
urlpatterns = [
    ...
    path('admin/articles/edit/<int:id>/', views.edit_article, name='edit_article'),  # Sửa bài viết
    path('admin/articles/delete/<int:id>/', views.delete_article, name='delete_article'),  # Xóa bài viết
]
